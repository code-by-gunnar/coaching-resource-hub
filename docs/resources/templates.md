...
- **[🚀 Initial Coaching Sessions](#initial-coaching-sessions)** - First meetings and relationship establishment
- **[🔄 Ongoing Session Templates](#ongoing-session-templates)** - Regular coaching conversation structures
- **[📊 Specialized Session Types](#specialized-session-types)** - Goal-setting, problem-solving, and progress reviews
- **[📧 Communication Templates](#communication-templates)** - Client emails and follow-up messages
- **[📋 Assessment & Intake Templates](#assessment--intake-templates)** - Forms and evaluation structures
- **[📅 Administrative Templates](#administrative-templates)** - Contracts, scheduling, and business processes
- **[🔚 Closure & Transition Templates](#closure--transition-templates)** - Ending sessions and program completion

---

## 🚀 Initial Coaching Sessions {#initial-coaching-sessions}
...
## 🔄 Ongoing Session Templates {#ongoing-session-templates}
...
## 📊 Specialized Session Types {#specialized-session-types}
...
## 📋 Assessment & Intake Templates {#assessment--intake-templates}
...
## 💡 Template Customization Guidelines {#closure--transition-templates}
...
#### **Before Each Session:**
□ Review template and customize for specific client
□ Prepare any materials or resources needed
□ Check technology and environment setup
□ Set personal intention and energy for session
□ Review client's previous session notes and commitments

#### **During Sessions:**
□ Stay flexible with template - follow client's needs
□ Track time to ensure all important elements are covered
□ Take notes for follow-up and future sessions
□ Notice what's working and what might need adjustment

#### **After Sessions:**
□ Complete session documentation promptly
□ Send follow-up email with summary and commitments
□ Update client progress tracking
□ Plan customizations for next session template
□ Reflect on template effectiveness and potential improvements
