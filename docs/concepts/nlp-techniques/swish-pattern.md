...
1. Start with the problem picture large and bright in front of you
2. Place a small, dim version of the outcome picture in the bottom corner
3. Rapidly "swish" the images - outcome picture explodes large and bright while problem picture shrinks to small and dim
4. Add a "whooshing" sound effect for kinesthetic impact
...
### 📋 Practical Tools
**[Swish Pattern Script Example →](./script.md)**  
...
<div class="video-container">
  <iframe src="https://www.youtube.com/embed/3t1xh1E7Xuo" allowfullscreen></iframe>
</div>
...
<div class="video-container">
  <iframe src="https://www.youtube.com/embed/DyRfpod2fxw" allowfullscreen></iframe>
</div>
...
**The Swish Formula:**
1. **Identify** the problem pattern and trigger
2. **Create** vivid problem picture (associated view)
3. **Design** compelling outcome picture (dissociated view)  
4. **Execute** rapid swish (explosion from small to large)
5. **Clear** screen and repeat 5-7 times
