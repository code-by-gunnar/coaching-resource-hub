...
**Reframing Process:**
1. Identify the challenging behavior or pattern
2. Ask: "What positive outcome is this trying to create?"
3. Acknowledge the positive intention
4. Explore alternative ways to achieve that outcome
...
1. **Identify:** What assumptions underlie the client's struggle?
2. **Question:** "What if that weren't true? What else could be true?"
3. **Explore:** Generate alternative assumptions
4. **Test:** "How would you feel/act if this new assumption were true?"
5. **Install:** Use evidence and experience to reinforce new assumption
...
1. **Identify Current Metaphor:** How does client describe their situation?
2. **Explore Alternative Metaphors:** What other metaphors could fit?
3. **Find Empowering Metaphor:** Which metaphor opens possibilities?
4. **Develop Metaphor:** What does this metaphor suggest about next steps?
5. **Live Metaphor:** How can client embody this new metaphor?
...
#### 🚫 Toxic Positivity
**Problem:** Forcing positive frames that ignore real pain or challenges
**Example:** "Everything happens for a reason" to someone experiencing trauma
**Solution:** Honor the difficulty while finding empowering elements within it

#### 🚫 Inauthentic Reframes
**Problem:** Creating reframes that don't resonate with client's values or experience
**Example:** Reframing introversion as "needing to be more social" for someone who values solitude
**Solution:** Find reframes that celebrate client's authentic nature

#### 🚫 Premature Reframing
**Problem:** Jumping to reframe before fully understanding client's current frame
**Example:** Immediately offering positive perspective without exploring client's experience
**Solution:** Deeply understand current frame before suggesting alternatives

#### 🚫 One-Size-Fits-All Reframes
**Problem:** Using same reframes for everyone regardless of individual circumstances
**Example:** Always reframing challenges as "growth opportunities"
**Solution:** Customize reframes to individual client's situation, values, and goals
...
<div class="video-container">
  <iframe src="https://www.youtube.com/embed/5_o6AE1mnEM?si=sFNJlSQEs1S8Cr7B" allowfullscreen></iframe>
</div>
...
**[Coaching Script: Framing & Reframing →](./script.md)**  
Complete coaching conversation examples with reframing techniques

**[I Am Thankful For - Gratitude Exercise (DOCX) →](https://hfmpacbmbyvnupzgorek.supabase.co/storage/v1/object/public/coaching-downloads/concepts/foundations-connection/i-am-thankful-for.docx)**  
